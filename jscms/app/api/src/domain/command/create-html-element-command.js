...
const { htmlTags } = require("../../../config/config.json");

class CreateHtmlElementCommand {
  constructor(element) {
    this.id = element.id;
  ...
  set _type(value) {
    if (!htmlTags.find((tag) => tag === value)) throw new CustomError("Invalid input tag name");
    this.type = value;
  }
  set _text(value) {
...
module.exports = CreateHtmlElementCommand;
